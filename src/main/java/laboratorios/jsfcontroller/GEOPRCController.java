...
@ManagedBean(name="geoprc")
@SessionScoped
public class GEOPRCController extends LaboratorioController{
    ...
    @PostConstruct
    public void init(){
        setTecnica(tecnicaFacade.findByNombre("Procesado de perfiles sísmicos"));
    }
