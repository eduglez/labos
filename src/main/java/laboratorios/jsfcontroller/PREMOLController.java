...
@ManagedBean(name="premol")
@SessionScoped
public class PREMOLController extends LaboratorioController{
    ...
    @PostConstruct
    public void init(){
        setTecnica(tecnicaFacade.findByNombre("Corte, molienda, pulverizado, tamizado y separación"));
    }
