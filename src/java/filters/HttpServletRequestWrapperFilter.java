...
public final class HttpServletRequestWrapperFilter extends AbstractConfigurationFilter {
    ...
    public void doFilter(final ServletRequest servletRequest, final ServletResponse servletResponse, final FilterChain filterChain) throws IOException, ServletException {
        ...
        if(session!=null){
            ...
            System.out.println("HttpServletRequestWrapperFilter.java HAY SESSION "+username);
            if(username!=null){
                System.out.println("[HttpServletRequestWrapperFilter,java] As logueao como: "+username);
                filterChain.doFilter(new CasHttpServletRequestWrapper((HttpServletRequest) servletRequest, username), servletResponse);
                return;
            }
        }
    ...
    final class CasHttpServletRequestWrapper extends HttpServletRequestWrapper {
        ...
        CasHttpServletRequestWrapper(final HttpServletRequest request, String username) {
            super(request);
            this.principal = null;
        ...
        public String getRemoteUser() {
            return principal != null ? this.principal.getName() : username;
        }
