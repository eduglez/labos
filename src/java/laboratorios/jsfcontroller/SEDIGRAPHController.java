...
@ManagedBean(name="anased")
@SessionScoped
public class SEDIGRAPHController extends LaboratorioController{
    ...
    @PostConstruct
    public void init(){
        setTecnica(tecnicaFacade.findByNombre("Análisis granulométrico por sedimentación (Sedigraph)"));
    }
