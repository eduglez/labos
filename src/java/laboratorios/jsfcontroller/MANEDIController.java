...
@ManagedBean(name="manedi")
@SessionScoped
public class MANEDIController extends LaboratorioController {
   @Resource(name = "mail/iactavisos")
    ...
    @PostConstruct
    public void init(){
        setTecnica(tecnicaFacade.findByNombre("Mantenimiento edificio"));
    }
...
//                ordenTrabajoLab.setRegistroFirmaPeticion("Firmado por "+login.getName()+" desde "+request.getRemoteAddr()+" a las "+df.format(new Date()));
    ...
    public void enviarMensajeEntregaResultados(){
        ...
        String titulo = "[MAN-EDI] Entrega de Resultados para "+nombreOrden;
        String mensaje = "El Servicio de Mantenimiento de Edificio ha terminado el Estudio para la Orden de Apoyo Técnico "+nombreOrden+"\r\n\r\n";
