...
@ManagedBean(name="anacs")
@SessionScoped
public class ANACSController extends LaboratorioController{
    ...
    @PostConstruct
    public void init(){
        setTecnica(tecnicaFacade.findByNombre("Análisis de C y S total por espectroscopía IR"));
    }
