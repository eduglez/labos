...
@ManagedBean(name="anagtk")
@SessionScoped
public class ANAGTKController extends LaboratorioController{
    ...
    @PostConstruct
    public void init(){
        setTecnica(tecnicaFacade.findByNombre("Escaneado y medida de propiedades físicas de sondeos"));
    }
